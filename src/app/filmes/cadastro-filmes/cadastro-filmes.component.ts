...
export class CadastroFilmesComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // if para caso ja estiver um filme sera usado e os campos serao preenchidos
    // com esses dados para uso da edição de tal filme
    if (this.id) {
      this.filmeService
        .visualizar(this.id)
      ...
      () => {
        const config = {
          data: {
            ...
            descricao:
              "Não conseguimos editar seu registro, por favor tentar novamente mais tarde",
            corBtnSucesso: "warn",
            btnSucesso: "Fechar",
          } as Alerta,
        };
